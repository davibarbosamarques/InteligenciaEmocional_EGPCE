            ...
            <div class="main-content container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 col-sm-8 container-fluid">
                        ...
                        <div class="row">
                                <div class="col-md-6">
                                    <br><p class="wow fadeInLeft" data-wow-delay="0.5s">Poucos de nós fomos ensinados a questionar sobre a nossa capacidade de compreender a nós mesmos e aos outros. Seus cuidadores na infância provavelmente lhe ensinaram a respeitar as outras pessoas, especialmente as mais velhas e as figuras hierárquicas, e também a amar o próximo e a tratar os demais com gentileza.</p>
                                    <br><p class="wow fadeInLeft" data-wow-delay="0.8s">Infelizmente, poucas pessoas estimuladas a respeitarem a si mesmas e a se tratarem com a mesma gentileza. O autorrespeito e o autocuidado são tomados como certos, como algo natural e, por isso, muitos pensam que eles não necessitam ser ensinados. Porém, se isso fosse verdade, não veríamos tantos casos de pessoas envolvidas em relações tóxicas.</p>
                                </div>
                                <div class="col-md-6">
                        <!-- Titulo Figura -->
                        <div class="text-center img-01 wow animate__zoomIn">
                            ...
                            <div class="zoom">
                                <a href="imagens/Figura01.png" data-bs-toggle="modal" data-bs-target="#Imagem01">
                                    <img src="imgs/topico03/Figura03.jpg" alt="Imagem que remete a organização" id="img-1">
                                </a>
                            </div>
                        ...
                        <div class="modal fade text-center" id="Imagem01" tabindex="-1"
                            ...
                            <div
                                ...
                                <div class="modal-content w-50">
                                    <img class="img-fluid" src="imgs/topico03/Figura03.jpg" alt="Alt da imagem fica aqui">
                                </div>
                        ...
                        <!-- Imagem 01 - End  (Audi)-->
                            ...
                            <p class="wow fadeIn" data-wow-delay="0.3s">É bastante comum que os pais ensinem aos filhos a se protegerem dos perigos externos. Ainda, mesmo que as crianças saibam como “jamais levar desaforo para casa” ou “nunca apanhar das outras crianças”, isso pode, em alguma medida, ser considerado como autocuidado. Também é bastante óbvio que atender às nossas necessidades biológicas - tais como comer, beber e dormir - é um cuidado que temos com o nosso corpo.</p>
                            ...
                            <section class="container">
                                ...
                                <section id="content">
                                    ...
                                    <p class="txt-caixasecundaria">No entanto, mesmo nesses aspectos mais básicos da vida, podemos perceber que poucos de nós fomos ensinados a refletir sobre como o que comemos, bebemos ou o modo como dormimos, afeta a nossa felicidade ou bem-estar, por exemplo. Em alguns ambientes familiares, nossos pais ou companheiros são bastantes gentis e nos questionam, por exemplo, sobre a qualidade do nosso sono ao amanhecer, mas você provavelmente nunca acordou e conversou consigo mesmo sobre o quão bem ou mal dormiu. Talvez você jamais tenha pensado sobre isso.
                                    </p><!--caixa secundaria-->
                                    </div>
                                </section>
                            </section>
                            ...
                            <blockquote class="blockquote">
                                <p><strong>Se você não consegue compreender a si mesmo, como poderá comunicar sobre você às outras pessoas?</strong></p>
                            </blockquote>
                            </figure>
                        </div>
                        <!-- Citação com borda verde (esquerda) -->
                        ...
                        <div class="bd-callout bd-callout-success m-3 wow fadeIn" data-wow-delay="0.3s">
                            ...
                            <figure>
                            <blockquote class="blockquote">
                                <p> Conhecer a si mesmo implica questionar-se, fazer estas perguntas na sua intimidade, pois a simples convivência leva ao efeito contrário. Convivemos tanto tempo com nós mesmos que nos tornamos familiarizados a ponto de não conversarmos conosco, e acabamos por dar ouvidos ao que outras pessoas nos dizem sobre nós. Por melhor que seja a intenção dessas pessoas, ninguém pode de fato lhe conhecer e cada impressão pessoal pode lhe tornar confuso, pois a tendência é que cada um lhe dê um feedback diferente sobre você.</p>
                            </blockquote>
                            </figure>
                        </div>
                        <!-- Citação com borda verde (esquerda) -->

                        <p class="wow fadeIn" data-wow-delay="0.3s">É fundamental que você conheça a si mesmo, e que faça com que seus olhos que olham para fora sejam direcionados para dentro. Quando abrimos os olhos, vemos o mundo, mas quando os fechamos, vemos a nós mesmos. Para alguns, fechar os olhos é ver apenas escuridão ou nada ver; porém qualquer um que, algum dia, tenha feito uma meditação, por exemplo, entende que, ao fecharmos os olhos, nos voltamos para o nosso universo e ele é tão ilimitado que podemos imaginá-lo sendo escuro ou sendo o lugar mais iluminado que existe.</p>
