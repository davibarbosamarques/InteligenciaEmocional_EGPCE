                    ...
                    <div class="col-md-10 col-sm-8 container-fluid">
                        ...
                        <div class="tudo">
                                        ...
                                        <div class="mensagem md-5">
                                            <p class=" text-left paragrafo mb-4">
                                                <strong>Olá [Nome_Completo],
                                                    Parabéns por avançar para o Módulo 02 do curso!</strong> É uma
                                                conquista notável e demonstra seu comprometimento e dedicação ao
                                                aprendizado.
                                            </p>
                                            <p class=" text-left paragrafo mb-4">
                                                Vamos ver se você entendeu sobre o Módulo 01 do curso. No módulo
                                                anterior, exploramos os aspectos fundamentais da Inteligência Emocional.
                                                Você aprendeu que o desenvolvimento da Inteligência Emocional é crucial
                                                para todos e que cada indivíduo possui a capacidade intrínseca de
                                                cultivar sua própria felicidade.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <p class="wow fadeIn mt-4" data-wow-delay="0.3s">
                                ...
                                também de lidar com as outras pessoas. Gerenciar as próprias emoções significa prestar
                                atenção às próprias necessidades, exercitando o autoconhecimento e o autocuidado. Lidar
                                com os sentimentos dos outros significa ter o aprendizado da empatia, responsabilidade
                                social e a compreensão de que cada ser é único e possui um ponto de vista particular.
                            </p>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse">
                                            <div class="accordion-body">
                                                ...
                                                compreensão do seu eu interior e na reflexão sobre seu relacionamento
                                                com os demais. O objetivo da minha abordagem será mostrar que,
                                                exercitando a sua Inteligência Emocional, você poderá conectar-se melhor
                                                consigo mesmo, prevenindo-se de problemas como estresse, depressão,
                                                ansiedades, entre outros, e também poderá ter relacionamentos afetivos e
