            ...
            <div class="main-content container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 col-sm-8 container-fluid">
                        ...
                        <div class="row d-flex jusfity-content-between div-img">
                            <div class="col-sm-12 col-md-6 img wow fadeInLeft" data-wow-delay="0.3s">
                                <img src="imgs-pessoas/Group 4.png" alt="" class="w-50">
                            </div>
                            <div class="col-sm-12 col-md-6 wow fadeInRight" data-wow-delay="0.3s">
                        ...
                        <p class="d-flex justify-content-center gap-1 mt-5 mb-5 collapse-pai wow animate__zoomIn"
                            ...
                            <button class="btn btn-collapse" type="button" data-bs-toggle="collapse"
                                ...
                                <i class="fa-regular fa-hand-pointer fa-beat" style="color: #fff;"></i> Clique para
                                saber mais...
                            </button>
                        </p>
                        <div class="collapse" id="collapseExample">
                            <div class="mt-3 text-collapse">
                                Também não tenho a pretensão de defender que o indivíduo deverá passar a permitir que o
                                ambiente em que está inserido lhe provoque emoções que lhe causam dor e que ele deve
                                apenas
                                pensar positivo em relação a elas. Na verdade, quando uma pessoa começa a nutrir
                                profundo
                                apreço por ela mesma, é bastante comum que ela passe a se afastar de vários tipos de
                                situações e pessoas. Entretanto, sempre que isso não for possível, a pessoa ainda assim
                            ...
                            <div class="collapse" id="collapseExample1">
                                <div class="mt-3 text-collapse mb-5">
                                    Não existe, portanto, qualquer intenção de anular emoções “negativas” em favor de
                                    emoções
                                    ...
                                    inconscientes e reativas. Como mostramos através da parábola da árvore dos desejos,
                                    nós
                        ...
                        <div class="bd-callout bd-callout-success m-3 wow fadeIn" data-wow-daley="0.3s">
                            ...
                            <figure>
                                <blockquote class="blockquote">
                                    <p>
                                        <strong>O que vamos focalizar a partir de agora é na verdadeira autoestima. Ela advém do
                                        nosso eu interior e independe completamente do julgamento alheio</strong>. Vamos olhar
